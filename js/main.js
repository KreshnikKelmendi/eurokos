...
var translations = {
    english: {
        ...
        "Contact": "Contact",
        "CountriesWeWork": "Countries we work in",
        "Capacity": "Total Capacity/ MW",
        "ConstructionProjects": "Construction Projects",
        "Establishment": "Year of establishment",
        "AboutUsTitle": "About us",
        "structure": "Organizational Structure, Expansion, and Collaboration of Eurokos with Other Companies",
        "descriptionStructure": "Eurokos, as a leader in its industry, has established a clear and well-defined organizational structure that ensures efficiency and effectiveness in its daily operations. Our organizational structure is divided into several levels and departments, each with specific responsibilities and functions that contribute to the achievement of the company's strategic goals.",
        "AboutUs": "15+ years of experience in the construction and building of roads, their maintenance, signaling, and the construction of hydroelectric power plants.",
        ...
        "FourthService": "Renewable Energy",
        ...
        "PrishtinaEnergyDescription": "The Prishtina Energy project delivers a robust 35 megawatts (MW) of power. The project employs state-of-the-art technology to ensure efficient and reliable energy production. Utilizing advanced engineering and cutting-edge components, Prishtina Energy stands as a testament to Eurokos's dedication to innovation and sustainability in the energy sector. The Prishtina Energy project is not just a technological achievement but also a boon for the local economy. It has created numerous jobs during its construction phase and continues to provide employment opportunities in its operational phase. Moreover, the project enhances energy infrastructure, fostering economic growth and stability in Prishtina.",
        "Installationpower": "Installation Power",
        "Energyproduced": "Energy Produced",
        "PrishtinaEnergyTitle": "Prishtina Energy 35[MW]",
        "EVWINDPARKDESCRIPTION": "The EV Wind Park in Zatriq is set to become a landmark project in renewable energy, boasting a significant capacity of 70 megawatts (MW). This state-of-the-art wind farm exemplifies the commitment to sustainable development and clean energy, leveraging cutting-edge technology and advanced engineering to deliver reliable and efficient power. Beyond its technological achievements, the EV Wind Park in Zatriq brings substantial economic and environmental benefits to the region. During its construction phase, the project has created numerous jobs, boosting the local economy. Once operational, the wind park will continue to offer employment opportunities, fostering long-term economic stability in the area.",
        "EVWindParkTitle": "EV Wind Park 70[MW]"
    },
    albanian: {
        "Home": "Ballina",
        "About": "Rreth Nesh",
        "Services": "Shërbimet",
        "Catalogue": "Katalogu ynë",
        "Project": "Projektet",
        "Contacts": "Kontakti",
        "Our roads last longer": "Rrugët tona jetojnë gjatë",
        "Welcome to our website!": "Mirë se vini në faqen tonë të internetit!",
        "Contact": "Kontakti",
        "CountriesWeWork": "Vendet ku punojmë",
        "Capacity": "Kapaciteti total/ MW",
        "ConstructionProjects": "Projektet e Ndërtimit",
        "Establishment": "Viti i themelimit",
        "AboutUsTitle": "Rreth Nesh",
        "structure": "Struktura organizative, zgjerimi dhe bashkëpunimi i Eurokos me kompani të tjera",
        "descriptionStructure": "Eurokos, si lider në industrinë e tij, ka krijuar një strukturë organizative të qartë dhe të mirëpërcaktuar që siguron efikasitet dhe efektivitet në operacionet e tij të përditshme. Struktura jonë organizative është e ndarë në disa nivele dhe departamente, secili me përgjegjësi dhe funksione specifike që kontribuojnë në arritjen e qëllimeve strategjike të kompanisë.",
        "AboutUs": "15+ vite përvojë në industrinë e ndërtimit dhe konstruktimit të rrugëve, mirëmbajtjes së tyre, sinjalizimit dhe implementimin e energjive të rinovueshme.",
        ...
        "FourthService": "Energjia e rinovueshme",
        ...
        "PrishtinaEnergyDescription": "Projekti i Energjisë Prishtina siguron një fuqi të fuqishme prej 35 megavatësh (MW). Projekti përdor teknologji të avancuar për të siguruar prodhim të energjisë efikas dhe të besueshëm. Duke përdorur inxhinieri të avancuar dhe komponentë të nivelit të lartë, Prishtina Energy qëndron si një dëshmi e përkushtimit të Eurokos për inovacion dhe qëndrueshmëri në sektorin e energjisë. Projekti i Energjisë Prishtina nuk është vetëm një arritje teknologjike, por edhe një përfitim për ekonominë lokale. Ai ka krijuar shumë vende pune gjatë fazës së ndërtimit dhe vazhdon të ofrojë mundësi punësimi gjatë fazës operative. Për më tepër, projekti përmirëson infrastrukturën e energjisë, duke nxitur rritjen ekonomike dhe stabilitetin në Prishtinë.",
        "Installationpower": "Fuqia Instaluese",
        "Energyproduced": "Energjia e Prodhuar",
        "PrishtinaEnergyTitle": "Prishtina Energy 35[MW]",
        "EVWINDPARKDESCRIPTION": "Parku me Turbina të Energjisë së Erës EV në Zatriq pritet të bëhet një projekt i rëndësishëm në energjinë e rinovueshme, duke u mburrur me një kapacitet të konsiderueshëm prej 70 megavatësh (MW). Ky park modern i erës përfaqëson përkushtimin ndaj zhvillimit të qëndrueshëm dhe energjisë së pastër, duke përdorur teknologji të përparuar dhe inxhinieri të avancuar për të siguruar energji të besueshme dhe efikase. Përveç arritjeve teknologjike, Parku me Turbina të Energjisë së Erës EV në Zatriq sjell përfitime të mëdha ekonomike dhe mjedisore për rajonin. Gjatë fazës së ndërtimit, projekti ka krijuar shumë vende pune, duke përforcuar ekonominë lokale. Pasi të jetë funksional, parku i erës do të vazhdojë të ofrojë mundësi punësimi, duke ndihmuar në stabilitetin ekonomik afatgjatë të zonës.",
        "EVWindParkTitle": "EV Wind Park 70[MW]"
    }
};
